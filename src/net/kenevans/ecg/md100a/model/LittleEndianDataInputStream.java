    ...
    DataInput
{
    ...
    /**
     * Reads signed short without converting.
     * 
     * @return
     * @throws IOException
     */
    public final short readBigEndianShort() throws IOException {
        return d.readShort();
    }

    /**
     * Reads unsigned short withoput converting. Note, returns int even though
     * it reads a short.
     * 
     * @return
     * @throws IOException
     */
    public final int readBigEndianUnsignedShort() throws IOException {
        return (int)d.readUnsignedShort();
    }
